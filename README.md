...
[Optional] git lfs install and pull
...
### [Optional] Delete files generated by preprocessing to get raw data 
Remove all json files.
Remove processed_demo.npz, indices_and_distances.npz, trajectory.npz for each demo.
...
```bash
python scripts/train_pi0_fast_ricl.py pi0_fast_droid_ricl --exp-name={ricl_retrain} --overwrite --finetuning_collected_demos_dir='preprocessing/collected_demos_training' --num_train_steps=10 --batch_size=1
```
